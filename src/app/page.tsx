...
import { HomyVibeShowcase } from "@/components/home/HomyVibeShowcase";
...
export default function HomePage() {
  return (
    <AppShell>
      ...
      <section className="relative mx-6 mb-12 overflow-hidden rounded-3xl bg-gradient-to-br from-amber-950 via-orange-900 to-rose-900 px-8 py-14 text-center text-white shadow-2xl shadow-orange-900/20 lg:mx-12">
