...
export function getPopularCategories() {
  return [
    { id: "shoes", label: "Shoes & sneakers", emoji: "👟", query: "running shoes" },
    { id: "clothing", label: "Clothing", emoji: "👕", query: "mens hoodie" },
    { id: "sports", label: "Sports & outdoors", emoji: "🏀", query: "basketball" },
    { id: "dairy", label: "Groceries & dairy", emoji: "🥛", query: "milk and eggs" },
    { id: "meat", label: "Meat & protein", emoji: "🍗", query: "chicken breast" },
    { id: "household", label: "Home essentials", emoji: "🧻", query: "paper towels" },
  ];
}
