/**
 * Amazon Product Advertising API — safe for CLI/cron (nightly index) and Next server.
 * App routes should import via `amazon-paapi-server.ts` (adds server-only guard).
 */
...
/** Live Amazon price + image via Product Advertising API 5.0. */
